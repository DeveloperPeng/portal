package com.ecad.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ecad.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.ecad.springboot.model" });
